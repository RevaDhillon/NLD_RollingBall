...
params.A     = 0.9;        % amplitude of forcing (cm or m)
params.omega = 2*pi*1.38;  % frequency in rad/s
params.phi   = 0;          % phase
params.theta = deg2rad(30);  % angle of forcing direction

% Initial conditions: [x0, y0, dx0, dy0]
y0 = [-6.555-0.2; -6.555-0.2; 0; 0];
...
[t, Y] = ode45(@(t, y) ball_dynamics(t, y, params), tspan, y0, opts);
